...
<head>
    ...
    <title>Forgot Password | MyBake</title>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="matric_no" required 
                            class="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-emerald focus:border-primary-emerald transition-all outline-none text-lg" 
