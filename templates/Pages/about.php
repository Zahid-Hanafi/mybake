...
<!-- Hero Banner -->
<div style="background:linear-gradient(135deg, var(--primary-emerald-dark), var(--primary-emerald)); padding:4rem 0; text-align:center; margin-bottom:0;">
    <div class="container">
...
<section style="display:grid; grid-template-columns:1fr 1fr; gap:4rem; align-items:center; margin-bottom:5rem;">
    <div>
        ...
        <p style="color:var(--text-muted); line-height:1.8; margin-bottom:1.5rem;">We specialize in three iconic traditional snacks — <strong style="color:var(--primary-emerald);">Bahulu</strong>, <strong style="color:var(--primary-emerald);">Rempeyek</strong>, and <strong style="color:var(--primary-emerald);">Kerepek Ubi</strong> — each crafted using time-honored family recipes, fresh local ingredients, and genuine care in every step of preparation.</p>
        <div style="display:flex; gap:1rem; flex-wrap:wrap;">
            <div style="text-align:center; padding:1rem 1.25rem; background:var(--primary-emerald-xlight); border-radius:12px; border:1px solid rgba(16,185,129,0.15);">
                <div style="font-family:'Playfair Display',serif; font-size:2rem; font-weight:800; color:var(--primary-emerald);">35+</div>
            ...
            <div style="text-align:center; padding:1rem 1.25rem; background:var(--primary-emerald-xlight); border-radius:12px; border:1px solid rgba(16,185,129,0.15);">
                <div style="font-family:'Playfair Display',serif; font-size:2rem; font-weight:800; color:var(--primary-emerald);">100%</div>
                <div style="font-size:0.75rem; color:var(--text-muted); font-weight:500;">Homemade Quality</div>
            </div>
        </div>
    </div>
    <div style="position:relative;">
        <div style="background:linear-gradient(135deg, var(--primary-emerald-dark), var(--primary-emerald-light)); border-radius:20px; padding:2.5rem 2.5rem 3.5rem 2.5rem; text-align:center; box-shadow:var(--shadow-lg);">
            ...
            <p style="color:rgba(255,255,255,0.7); font-size:0.875rem; line-height:1.6; margin:0;">Every product is made using recipes passed down through generations, preserving the authentic taste of Malaysian heritage.</p>
        </div>
        <div style="position:absolute; bottom:-1.5rem; left:50%; transform:translateX(-50%); background:#fff; border-radius:16px; padding:1rem 1.25rem; box-shadow:var(--shadow-md); border:1px solid var(--border-light); width: max-content;">
...
<section style="margin-bottom:5rem;">
    ...
    <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:1.5rem;">
        <?php
        $products_info = [
            ['🍪','Bahulu','Traditional pandan-scented sponge cakes baked in decorative molds. Available in 4 varieties: Cermai, Ikan, Pecah Lapan, and Gulung. Light, airy and perfectly sweet.','var(--primary-emerald)','var(--primary-emerald-xlight)'],
        ...
        <div class="card" style="text-align:center; padding:2rem;">
            ...
            <h3 style="font-family:'Playfair Display',serif; font-size:1.25rem; margin-bottom:0.75rem; color:<?= $info[3] ?>;"><?= $info[1] ?></h3>
            <p style="color:var(--text-muted); font-size:0.875rem; line-height:1.7;"><?= $info[2] ?></p>
        </div>
        <?php endforeach; ?>
    </div>
</section>
...
<section style="display:grid; grid-template-columns:1fr 1fr; gap:1.5rem;">
    ...
    <div style="background:linear-gradient(135deg,var(--primary-emerald-dark),var(--primary-emerald)); border-radius:20px; padding:2.5rem; color:#fff; text-align:center;">
